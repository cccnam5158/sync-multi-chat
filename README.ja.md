...
1.  最新のインストーラーをダウンロードします: [Sync-Multi-Chat-Setup-0.7.1.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.7.1/Sync-Multi-Chat-Setup-0.7.1.exe)

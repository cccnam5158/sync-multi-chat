...
1.  最新インストーラー: [Sync-Multi-Chat-Setup-0.10.0-x64.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.10.0/Sync-Multi-Chat-Setup-0.10.0-x64.exe)
2.  インストールウィザードに従います。
3.  起動時にアップデートを確認します。

...
1.  最新のインストーラーをダウンロードします: [Sync-Multi-Chat-Setup-0.8.2.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.8.2/Sync-Multi-Chat-Setup-0.8.2.exe)

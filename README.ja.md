...
1.  最新のインストーラーをダウンロードします: [Sync-Multi-Chat-Setup-0.8.0.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.8.0/Sync-Multi-Chat-Setup-0.8.0.exe)

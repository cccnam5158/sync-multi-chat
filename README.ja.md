...
1.  最新のインストーラーをダウンロードします: [Sync-Multi-Chat-Setup-0.5.12.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.5.12/Sync-Multi-Chat-Setup-0.5.12.exe)

...
1.  최신 설치 파일을 다운로드합니다: [Sync-Multi-Chat-Setup-0.7.0.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.7.0/Sync-Multi-Chat-Setup-0.7.0.exe)

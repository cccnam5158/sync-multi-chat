...
1.  Download the latest installer: [Sync-Multi-Chat-Setup-0.5.9.exe](https://github.com/cccnam5158/sync-multi-chat/releases/download/v0.5.9/Sync-Multi-Chat-Setup-0.5.9.exe)
